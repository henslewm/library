	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Type Definitions" Type="Folder">
			<Item Name="Controls" Type="Folder">
				<Item Name="Disconnect Control.ctl" Type="VI" URL="../controls/Disconnect Control.ctl"/>
				<Item Name="Download Control.ctl" Type="VI" URL="../controls/Download Control.ctl"/>
				<Item Name="Exit Control.ctl" Type="VI" URL="../controls/Exit Control.ctl"/>
				<Item Name="Clear Control.ctl" Type="VI" URL="../controls/Clear Control.ctl"/>
				<Item Name="COM Port Control.ctl" Type="VI" URL="../controls/COM Port Control.ctl"/>
				<Item Name="Date Control.ctl" Type="VI" URL="../controls/Date Control.ctl"/>
				<Item Name="IP Phone Number Control.ctl" Type="VI" URL="../controls/IP Phone Number Control.ctl"/>
				<Item Name="Save Path Control.ctl" Type="VI" URL="../controls/Save Path Control.ctl"/>
				<Item Name="Reboot Control.ctl" Type="VI" URL="../controls/Reboot Control.ctl"/>
			</Item>
			<Item Name="Indicators" Type="Folder">
				<Item Name="Connected Indicator.ctl" Type="VI" URL="../controls/Connected Indicator.ctl"/>
				<Item Name="Output Indicator.ctl" Type="VI" URL="../controls/Output Indicator.ctl"/>
				<Item Name="Station ID Indicator.ctl" Type="VI" URL="../controls/Station ID Indicator.ctl"/>
			</Item>
			<Item Name="GLDL UI Data.ctl" Type="VI" URL="../controls/GLDL UI Data.ctl"/>
			<Item Name="Special Cases from XPert.ctl" Type="VI" URL="../controls/Special Cases from XPert.ctl"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Enqueue Message.vi" Type="VI" URL="../../Great Lakes Downloads/support/Message Queue/Enqueue Message.vi"/>
			<Item Name="Enqueue Message (Single).vi" Type="VI" URL="../../Great Lakes Downloads/support/Message Queue/Enqueue Message (Single).vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Main Application" Type="EXE">
				...
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/GLDL Main.vi</Property>
